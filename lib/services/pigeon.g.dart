...
class ArticleApi {
  ...
  ArticleApi({BinaryMessenger? binaryMessenger}) : _binaryMessenger = binaryMessenger;
  ...
  Future<List<Article?>> articles() async {
    final BasicMessageChannel<Object?> channel = BasicMessageChannel<Object?>(
        'dev.flutter.pigeon.ArticleApi.articles', codec, binaryMessenger: _binaryMessenger);
